                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                            <li class="active">
                              ...
                              <li class=" ">
                                  <a href="web/alumnos.php" class="waves-effect waves-dark">
                              ...
                              <li class=" ">
                                    <a href="web/carreras.php" class="waves-effect waves-dark">
                            ...
                            <li class=" ">
                                <a href="web/personal.php" class="waves-effect waves-dark">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                            <li class=" ">
                                <a href="web/reg_datos.php" class="waves-effect waves-dark">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                            <li class=" ">
                                <a href="web/actions/cerrars.php" class="waves-effect waves-dark">
