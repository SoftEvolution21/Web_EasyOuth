                                                    ...
                                                    <div class="tab-pane active" id="tutores" role="tabpanel">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-block">
                                                                <form method="post" action="actions/modificA.php?id=<?php print $mostrar['idtbl_user'] ?>" class="form-material">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="matricula" value="<?php echo $mostrar['matriculauser'] ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="nombre" value="<?php echo $mostrar['tx_nombreuser'] ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="apellidop" value="<?php echo $mostrar['tx_appaterno'] ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="apellidom" value="<?php echo $mostrar['tx_apmaterno'] ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="contraseña" value="<?php echo $mostrar['tx_password'] ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="turno" value="<?php echo $mostrar['turno'] ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                    <div class="dropdown-primary dropdown open">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                            <?php
                                                                                ...
                                                                                $querys = "SELECT * FROM tbl_user INNER JOIN carrera WHERE tbl_user.idtbl_user=$id and carrera.idcarrera= tbl_user.idcarrera";
                                                                                $ress = mysqli_query($con, $querys);
                                                                                while($mostrars=mysqli_fetch_array($ress)){
                                                                                ?>
                                                                                    <option value="<?php echo $mostrars['idcarrera'] ?>"><?php echo $mostrars['tx_carrera'] ?></option>
                                                                                <?php
                                                                                }
                                                                        ...
                                                                        <select class="dropdown-toggle waves-effect waves-light" id="dropdown-2" name="cuatrimestre" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" required="">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $querys = "SELECT * FROM tbl_user INNER JOIN cuatrimestre WHERE tbl_user.idtbl_user=$id and cuatrimestre.idcuatrimestre= tbl_user.idcuatrimestre";
                                                                                $ress = mysqli_query($con, $querys);
                                                                                while($mostrars=mysqli_fetch_array($ress)){
                                                                                ?>
                                                                        ...
                                                                        <select class="dropdown-toggle waves-effect waves-light" name="grupo" id="dropdown-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" required="">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $querys = "SELECT * FROM tbl_user INNER JOIN grupo WHERE tbl_user.idtbl_user=$id and grupo.idgrupo= tbl_user.idgrupo";
                                                                                $ress = mysqli_query($con, $querys);
                                                                                while($mostrars=mysqli_fetch_array($ress)){
                                                                                ?>
