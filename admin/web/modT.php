                                                    ...
                                                    <div class="tab-pane active" id="tutores" role="tabpanel">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h5>Modificar Tutor</h5>
                                                            </div>
                                                            <div class="card-block">
                                                                <form method="post" action="actions/modificT.php?id=<?php print $mostrar['id_tutor'] ?>" class="form-material">
                                                                    <div class="form-group form-primary">
                                                                        <input type="text" name="cedula" value="<?php echo $mostrar['cedula'] ?>" class="form-control" required="">
                                                                    ...
                                                                    <div class="dropdown-primary dropdown open">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                            <?php
                                                                                ...
                                                                                $querys = "SELECT * FROM tutor INNER JOIN carrera WHERE tutor.id_tutor=$id and carrera.idcarrera= tutor.idcarrera";
                                                                        ...
                                                                        <select class="dropdown-toggle waves-effect waves-light" id="dropdown-2" name="cuatrimestre" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" required="">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $querys = "SELECT * FROM tutor INNER JOIN cuatrimestre WHERE tutor.id_tutor=$id and cuatrimestre.idcuatrimestre= tutor.idcuatrimestre";
                                                                                $ress = mysqli_query($con, $querys);
                                                                                while($mostrars=mysqli_fetch_array($ress)){
                                                                                ?>
                                                                        ...
                                                                        <select class="dropdown-toggle waves-effect waves-light" name="grupo" id="dropdown-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" required="">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $querys = "SELECT * FROM tutor INNER JOIN grupo WHERE tutor.id_tutor=$id and grupo.idgrupo= tutor.idgrupo";
                                                                                $ress = mysqli_query($con, $querys);
                                                                                while($mostrars=mysqli_fetch_array($ress)){
                                                                                ?>
