                                                        ...
                                                        <tbody>
                                                            <?php 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="actions/deleteC.php?id=<?php print $mostrar['idcarrera'] ?>" class="waves-effect waves-dark">
                                                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Eliminar |</span>
                                                                        <span class="pcoded-mcaret"></span>
                                                                        </a>
                                                                        
                                                                        <a href="modC.php?id=<?php print $mostrar['idcarrera'] ?>" class="waves-effect waves-dark">
