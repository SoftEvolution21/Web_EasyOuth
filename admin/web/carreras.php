                                                        ...
                                                        <tbody>
                                                            <?php 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="modC.php?id=<?php print $mostrar['idcarrera'] ?>" class="btn btn-info btn-round waves-effect waves-dark">
                                                                        Modificar
                                                                        </a>

                                                                        <a href="actions/deleteC.php?id=<?php print $mostrar['idcarrera'] ?>" class="btn btn-danger btn-round waves-effect waves-dark">
                                                                        Eliminar
                                                                        </a>
                                                                    </td>
                                                                </tr>
