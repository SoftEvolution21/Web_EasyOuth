...
<header>
    ...
    $db = new Database();
    $consulta= $db->connect()->prepare('SELECT * FROM tbl_user');
    ...
    <table class="tabla_datos">
        ...
        <td><a class="btn-add" href="actions/agregarD.php">Nuevo Docente</a></td>
        </tr>
        </thead>

        <?php 
        $sql="SELECT * FROM tbl_user WHERE idctg_tipousuario=4 ORDER BY tx_appaterno ASC";
        ...
        <tr>
            ...
            <td>
                <a class="btn-warning" href="actions/deleteD.php?id=<?php print $mostrar['idtbl_user'] ?>">Eliminar</a>
                | 
                <a class="btn-mod" href="actions/modificD.php?id=<?php print $mostrar['idtbl_user'] ?>">Modificar</a></td>
        </tr>
  <?php 
  }
   ?>
