                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="nombre" id="inp1" class="form-control" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Ingresa tu Usuario</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="passwd" id="inp3" class="form-control" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Ingresa tu Contraseña</label>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <input type="submit" value="Ingresar" class="btn btn-primary btn-md btn-block btn-round waves-effect waves-light text-center m-b-20">
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
